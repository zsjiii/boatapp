...
0x44,0x16,0x0,0x0,0x37,0x32,0x33,0x31,
...
const auto doCall = [&]() {
    void *args[] = {nullptr};
    return aotContext->callObjectPropertyLookup(10, r7_0, args, 0);
};
const auto doInit = [&]() {
    aotContext->initCallObjectPropertyLookup(10, r7_0, 24);
};
#ifndef QT_NO_DEBUG
...
aotContext->setInstructionPointer(10);
#endif
aotContext->initGetObjectLookup(24, r2_2);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<QString *>(argv[0]) = QString();
